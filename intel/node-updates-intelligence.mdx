...
<Note> This service is currently available to enterprise users only Contact us at support@scale3labs.com if you're interested in signing up. </Note>
...
2. Click on **Intel** from the top panel. Then click on **API key** to view your API key. You can generate a new API key by clicking on **Re-generate API key** button below.

![Alt text](/images/intel-api-key.png)
