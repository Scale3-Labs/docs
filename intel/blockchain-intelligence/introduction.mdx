...
1. **Log in to your account**: Sign up for a [Scale3 Autopilot](https://app.scale3labs.com/signin) account if you haven't. Navigate to [Scale3 Autopilot](https://app.scale3labs.com//signin) and log in once you have an account.
2. **Go to Intel tab**: Once logged in, click on the "Intel" tab then API key.

  <Note> Note: If you don't see this tab, you likely don't have an Enterprise license. Contact support@scale3labs.com </Note>
