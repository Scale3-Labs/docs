...
- This completes the installation of the Scale3 CLI on your node. You can see [Monitoring](/monitoring/push-method) section to setup monitoring and [Logging](/logging/getting-started) section to setup logging