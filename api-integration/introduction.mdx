We currently offer Blockchain Intelligence APIs integrations for the following workflows:
...
- Setting up Alerts for:
  ...
  - Node software update intelligence
...
#### Sample dashboard
![Scale3 Monitoring](/images/scal3-dash.png) 
