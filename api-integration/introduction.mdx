...
- **Hook real-time network intelligence and Software releases to your Devops channels** - Setup alerts for your devops channels to get real-time updates on network intelligence and software releases. This can be used:
...
#### Real-time Feed - Network intelligence
