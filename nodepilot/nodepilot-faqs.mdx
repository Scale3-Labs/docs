...
<Accordion title="What is your Nodepilot?">
	...
	cloud providers like GKE, AWS, Azure, etc. You provide the necessary information, and
...
<Accordion title="What cloud providers do you support?">
	Primarily we support provisioning on AWS, GCP and Azure. If you already have a server
	provisioned anywhere (cloud or datacenter), we can help set up a blockchain node on
	it as well. Please reachout to us if you have custom requirements, we are happy to help.
</Accordion>
