# How to Silence an Alert in Grafana 10
...
### 4. **Silence the Alert**
   ...
   - Click on the alert name to open the alert details.
...
### 5. Choose slience duration**
   ...
   In the Slience start and end section, select how long the alert should be silenced for. You may add a note or annotation to document why the alert was paused in the comment section.
