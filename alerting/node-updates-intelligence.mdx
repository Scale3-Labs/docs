...
![Alt text](/images/apikey-tab.png)

3. **Generate API Key**: Click on the "Refresh API Key" button.
    
![](/images/api-key.png)
    
4. **Configure Scopes (Node Updates Intel Only)**: Select the scopes that you need. For querying node updates, you will need the **`READ_NODE_UPDATES`** scope.
